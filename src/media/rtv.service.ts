...
export class RtvService {
  ...
  getAllMovies(): Promise<any> {
    ...
    const callback = 'jQuery112406627142731271161_1556794600130';
    // the api request as performed by the browser, searching documentaries
    const url = `https://api.rtvslo.si/ava/getSearch?client_id=${process.env.CLIENT_ID}&q=&showTypeId=15890841&sort=date&order=desc&pageSize=99&pageNumber=0&source=&hearingAid=0&clip=show&from=2007-01-01&to=&WPId=&zkp=0&callback=${callback}&_=1556794600131`;
